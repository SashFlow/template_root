			...
			<div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-end">
				...
				<div className="lg:col-span-4 pb-4">
					...
					<div className="flex flex-wrap gap-4">
						<button
							type="button"
							className="bg-primary text-primary-foreground px-8 py-4 font-approachable font-bold uppercase text-sm tracking-widest hover:brightness-110 transition-all"
						>
							Get in Touch
						</button>
						<button
