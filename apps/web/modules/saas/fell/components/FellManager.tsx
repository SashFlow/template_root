...
export function FellManager({ initialFells }: { initialFells: FellItem[] }) {
	...
	const uploadCoverImage = async (
		...
		try {
			const { signedUploadUrl, publicUrl } =
				await getFellCoverUploadUrl(fellId);
								...
								<div
									...
									dangerouslySetInnerHTML={{
										__html: tiptapJsonToHtml(
											fell.content as Parameters<
												typeof tiptapJsonToHtml
											>[0],
										),
									}}
								/>
