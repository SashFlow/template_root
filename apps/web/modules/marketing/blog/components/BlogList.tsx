...
<p><img src="https://www.huohuo90.com:3000/files/1730120412568.jpg" alt="野花" style="max-width:100%;border-radius:8px;margin:12px 0" /><img src="https://www.huohuo90.com:3000/files/1730120413042.jpg" alt="野花" style="max-width:100%;border-radius:8px;margin:12px 0" /><img src="https://www.huohuo90.com:3000/files/1730120412848.jpg" alt="野花" style="max-width:100%;border-radius:8px;margin:12px 0" /><img src="https://www.huohuo90.com:3000/files/1730120413464.jpg" alt="野花" style="max-width:100%;border-radius:8px;margin:12px 0" /></p>
<p>赛马是在下午，上午这时已经有很多马匹和选手在赛场。马有高有矮相差好大，选手看着也是有装束专业和平常随意的。不过高大的马还真高，四条腿修长，一看就是能跑的。赛马场我们没有长留，转了一圈就走了。</p>
<p><img src="https://www.huohuo90.com:3000/files/1730120437224.jpg" alt="赛马" style="max-width:100%;border-radius:8px;margin:12px 0" /><img src="https://www.huohuo90.com:3000/files/1730120437072.jpg" alt="赛马" style="max-width:100%;border-radius:8px;margin:12px 0" /><img src="https://www.huohuo90.com:3000/files/1730120437453.jpg" alt="赛马" style="max-width:100%;border-radius:8px;margin:12px 0" /></p>
<p>门源油菜花，又到了看油菜花的地方了。再好好看看油菜花吧，这大片大片的黄色油菜花田。</p>
<p><img src="https://www.huohuo90.com:3000/files/1730120459969.jpg" alt="油菜花" style="max-width:100%;border-radius:8px;margin:12px 0" /></p>
<p>今天有一段路上的景色很美，路过一些村落的油菜花更让人向往，感觉很惬意。村落被遍野的油菜花包围着，不是很高的后山，蓝天上飘着大朵大朵的白云。如果骑一匹好马，奔在后山上或是放羊或是只为了骑马奔跑，去行走在山坡上与天相交的地方。这里空气清新，阳光正好。</p>
<p><img src="https://www.huohuo90.com:3000/files/1730120487674.jpg" alt="沿途风景" style="max-width:100%;border-radius:8px;margin:12px 0" /></p>
...
function toUnifiedPosts(notes: PublishedNote[]): UnifiedPost[] {
	return notes.map((note) => ({
		...
		summary:
			note.description ||
			tiptapJsonToText(
				note.content as Parameters<typeof tiptapJsonToText>[0],
			).slice(0, 100),
		content: tiptapJsonToHtml(
			note.content as Parameters<typeof tiptapJsonToHtml>[0],
		),
...
function hardcodedToUnified(posts: BlogPost[]): UnifiedPost[] {
...
export function BlogList({
	...
	// Merge hardcoded posts and published notes
	const allPosts = [
		...toUnifiedPosts(publishedNotes),
			...
			<div className="flex flex-col gap-8">
				{filteredPosts.map((post) => (
					<button
						...
						className="group cursor-pointer rounded-2xl border bg-card p-5 text-left transition-shadow hover:shadow-lg"
					>
						<div className="flex items-start gap-5">
							{/* Cover image */}
							{post.image && (
								<div className="-mt-12 h-[120px] w-[160px] shrink-0 overflow-hidden rounded-xl shadow-md">
									<img
										src={post.image}
										alt={post.title}
